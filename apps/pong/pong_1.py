...
from apps.pong.game_constructor import Ball, Wall, PlayerPlatforms
...
class PongMode1:
    ...
    def draw(self):
        # draw game_area:
        pg.draw.line(self.screen, self.game.color_2, (self.screen_width // 2, 0), (self.screen_width // 2, self.screen_height))
        pg.draw.line(self.screen, self.game.color_2, (self.screen_width // 2 - 30, self.screen_height // 2), (self.screen_width // 2 + 30, self.screen_height // 2))
        pg.draw.circle(self.screen, self.game.color_2, (self.screen_width // 2, self.screen_height // 2), 20, 1)
        # draw walls:
