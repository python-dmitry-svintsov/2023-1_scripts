...
class Fractal_4:
    def __init__(self, main):
        ...
        # taichi
        ti.init(arch=ti.cpu)
        self.screen_field = ti.Vector.field(3, ti.uint8, (self.screen_width, self.screen_height))
        self.texture_field = ti.Vector.field(3, ti.uint8, self.texture.get_size())
        self.texture_field.from_numpy(self.texture_array)

    def get_texture(self):
        self.texture = pg.image.load('.\\venv\\fractal_Mandelbrutta\\textures\\1.jpg')
